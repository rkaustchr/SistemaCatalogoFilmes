 ...
 * @author Admin
 */
public class frmMeusFilmes extends javax.swing.JFrame {

    /**
     * Creates new form frmMeusFilmes
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmMeusFilmes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmMeusFilmes().setVisible(true);
            }
        });
    }
